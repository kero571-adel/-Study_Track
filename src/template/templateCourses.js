...
import {
  ...
  Button, Typography, Box, Chip, Pagination,
  FormControl, InputLabel, Select, MenuItem, TextField,
  Avatar, Rating, IconButton
} from '@mui/material';
import {
  FilterList, Search, Favorite, Share,
  PlayCircleOutline, Schedule, People
...
const coursesData = [
  ...
  },
  {
    ...
    category: 'برمجة',
    description: 'تعلم كيفية بناء تطبيقات الخادم باستخدام Node.js وإنشاء واجهات برمجة تطبيقات (APIs) قوية.'
  },
  {
    id: 3,
    ...
    category: 'تصميم',
    description: 'أتقن تصميم واجهات المستخدم وتجربة المستخدم من خلال هذه الدورة الشاملة.'
  },
  {
    id: 4,
    ...
    price: 'مجاني',
    category: 'برمجة',
    description: 'ابدأ رحلتك في تعلم Python واستخدامها في تحليل البيانات وعلم البيانات.'
  },
  {
    id: 5,
    ...
    category: 'أمن',
    description: 'تعلم أساسيات الأمن السيبراني وكيفية حماية أنظمتك من الهجمات الإلكترونية.'
  },
  {
    id: 6,
...
// التصنيفات المتاحة
const categories = ['الكل', 'برمجة', 'تصميم', 'أمن', 'عمليات', 'تسويق', 'إدارة'];
// المستويات المتاحة
...
const CoursesPage = () => {
  ...
  // تصفية الكورسات بناءً على المعايير المحددة
  ...
  // الحصول على الكورسات للصفحة الحالية
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        {/* <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
          <Typography variant="body1" color="text.secondary">
            عرض {currentCourses.length} من {filteredCourses.length} دورة
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <FilterList sx={{ mr: 1 }} />
            <Typography variant="body2">ترتيب حسب: الأكثر شهرة</Typography>
          </Box>
        </Box> */}
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
                    ...
                    <Box>
                      {course.price === 'مدفوع' ? (
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                          <Typography variant="body2" sx={{ textDecoration: 'line-through', mr: 1, color: 'text.secondary' }}>
                  ...
                  <Typography gutterBottom variant="h6" component="h2" sx={{ mt: 1, height: 64, overflow: 'hidden' }}>
                    {course.title}
                  </Typography>
                  ...
                  <Chip label={course.level} size="small" variant="outlined" sx={{ mt: 1 }} />
                </CardContent>
